...
interface WizardState {
  ...
  automaticMessages: { /* unchanged */ };
  inviteList: { /* unchanged */ };
}
```
...
```json
{
  "vendor_application": {
    "payment_prices": [
      ...
      { "type": "early_bird_price", "label": "Early Bird Rate", "amount": 275, "is_percentage": false, "early_bird_deadline": "2026-06-01" }
    ],
    "payment_engines": []
  },
  "event": {
