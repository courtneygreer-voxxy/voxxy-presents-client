...
**Frontend (Completed):** 6. ✅ Fix table header scrolling 7. ✅ Remove invitation email special case (unified with Position 1)

**Optional (Future Enhancement):** 8. 💡 Add bulk deliveries endpoint to reduce N+1 queries 9. 💡 Add `include_delivery_counts` param to skip delivery fetches on auto-refresh
