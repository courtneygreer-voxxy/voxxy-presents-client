# VOXXY Presents - Landing Page Copy

**Current Version:** 2.0
**Last Updated:** January 15, 2026
**Status:** Updated with winning language and SEO optimization
...
**Headline:** Vendor Relationships That Compound
...
**Headline:** Review 200 Applications in Hours, Not Days
...
**Headline:** Automated Emails, Zero Setup

**Description:** Confirmations, approvals, rejections, payment reminders, day-of logistics — all automated. Stop copying and pasting the same messages.
...
- Long-tail SEO targeting actual customer search behavior
...
- Replace 5 tools with one system
- Focus on the event, not the inbox
...
- **Numbers matter** - 15-20 hours, 5-7 tools, 200+ applications
- **Compound value** - Build relationships that last
...
- PresentsHeader2.svg
- PresentsHeader3.svg
- courtandbeau.png (possible testimonial/case study image)
- HEADER.svg
- **og-image.jpg** ✅ (newly created)
...
- Real product screenshots for each feature:
  ...
  2. Vendor profile with history/notes
...
4. **Specific metrics:** "Save 15+ hours per event" callout
5. **FAQ section:** Long-tail SEO
6. **Case studies:** "A Taste of Brooklyn" story
...
4. Create blog content for event producer keywords
5. Target long-tail: "how to manage art market vendors," etc.
...
- `public/robots.txt` - Added for voxxyai.com blocking
...
- No testimonials/social proof sections

These visual updates are recommended for Phase 2 when product screenshots are captured.
