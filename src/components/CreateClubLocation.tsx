    ...
    <div className="space-y-6">
      <div className="text-center mb-8">
        <div className="flex items-center justify-center gap-2 mb-4">
          ...
          <h2 className="text-2xl font-bold text-gray-900">Where do you usually meet?</h2>
        </div>
        <p className="text-gray-600">Help people know what to expect (you can always change this later) 📍</p>
      </div>
