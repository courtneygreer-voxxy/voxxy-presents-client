    ...
    <div className="space-y-4">
      <div>
        ...
        <p className="text-xs text-muted-foreground mb-4">
          Choose a background style for your club page. Works beautifully with glass morphism
          design.
        </p>
      </div>
          ...
          >
            <CardContent className="p-4">
              <div className="flex items-start justify-between mb-2">
                ...
                {currentBackground === option.id && <Check className="h-4 w-4 text-primary" />}
              </div>
              ...
              {/* Preview Box */}
              <div
                className={`mt-3 h-12 rounded border border-border relative overflow-hidden ${getPreviewClasses(option.id)}`}
              >
