            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-3">
              <div>
                <label
                  ...
                  className="block text-foreground text-sm font-medium mb-1.5 dark:text-foreground/90 flex items-center gap-2"
                >
              ...
              <div className="mt-6 pt-6 border-t border-border">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-xs text-foreground/50">
                    ({contact.total_applications || 0} application
                    {contact.total_applications !== 1 ? 's' : ''} • {contact.total_events || 0}{' '}
                    event{contact.total_events !== 1 ? 's' : ''})
                  </span>
                </div>
            ...
            {contact.change_history && contact.change_history.length > 0 && (
              <div className="mt-6 pt-6 border-t border-border">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-xs text-foreground/50">
                    ({contact.change_history.length} change
                    {contact.change_history.length !== 1 ? 's' : ''})
                  </span>
                </div>
                ...
                <div className="space-y-2 max-h-40 overflow-y-auto">
                  {contact.change_history.map((change, index) => (
                    ...
                    >
                      ...
                      <div className="mt-1 text-foreground/50">via {change.event_name}</div>
                    </div>
                  ))}
                </div>
              </div>
