    ...
    <div ref={wrapperRef} className="relative">
      ...
      <div className="relative">
        <input
          ...
          className={`w-full px-3 py-2 pl-8 text-sm rounded-lg bg-white/10 border ${
      ...
      {isOpen && suggestions.length > 0 && (
        <div className="absolute z-50 w-full mt-1.5 bg-gray-900/95 backdrop-blur-sm border border-white/20 rounded-lg shadow-xl max-h-64 overflow-y-auto">
          {suggestions.map((place, index) => (
            <button
              ...
              className={`w-full text-left px-3 py-2 transition-colors border-b border-white/10 last:border-b-0 ${
                index === selectedIndex
            ...
            >
              <div className="flex items-start gap-2">
                <MapPin className="w-3.5 h-3.5 mt-0.5 text-white/60 flex-shrink-0" />
      ...
      {isOpen && !isLoading && suggestions.length === 0 && value.length >= 2 && (
        <div className="absolute z-50 w-full mt-1.5 bg-gray-900/95 backdrop-blur-sm border border-white/20 rounded-lg shadow-xl p-3 text-center text-white/60 text-sm">
