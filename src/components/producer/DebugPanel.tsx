      ...
      <div className="flex items-center gap-3 mb-3">
        ...
        <div>
          <h3 className="flex items-center gap-2 font-mono text-sm font-bold text-red-700 dark:text-red-300">
            <span className="text-green-400">{'>'}</span> DEBUG_
            {title.toUpperCase().replace(/\s/g, '_')}
          </h3>
          <p className="font-mono text-[10px] text-red-700/70 dark:text-red-400/60">
            admin.debug.context
          </p>
        </div>
        <div className="ml-auto px-2 py-1 bg-red-500/20 border border-red-400/50 rounded">
          <p className="font-mono text-[9px] font-bold text-red-700 dark:text-red-300">
            ADMIN ONLY
          </p>
        </div>
      </div>
