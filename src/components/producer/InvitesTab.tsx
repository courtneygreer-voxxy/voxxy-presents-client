                              ...
                              {updatingId === row.id ? (
                                ...
                                <div className="flex gap-2">
                                  <button
                                    ...
                                    className="flex-1 px-3 py-2 rounded-lg bg-green-600 text-white hover:bg-green-700 transition-smooth text-xs font-medium"
                                  >
                                    Approve
                                  </button>
                                  <button
                                    onClick={() => handleUpdateStatus(row, 'waitlist')}
                                    className="flex-1 px-3 py-2 rounded-lg border border-yellow-500/30 text-yellow-400 hover:bg-yellow-500/10 transition-smooth text-xs font-medium"
                                  >
                                    Waitlist
                                  </button>
                                  <button
                                    onClick={() => handleUpdateStatus(row, 'declined')}
                                    className="flex-1 px-3 py-2 rounded-lg border border-red-500/30 text-red-400 hover:bg-red-500/10 transition-smooth text-xs font-medium"
                                  >
                                    Decline
                                  </button>
                                </div>
