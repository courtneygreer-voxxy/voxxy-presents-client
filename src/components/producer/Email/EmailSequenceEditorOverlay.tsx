...
export default function EmailSequenceEditorOverlay({
  ...
  const handleSendTest = async () => {
    ...
    try {
      const result = await scheduledEmailsApi.sendTest(
        eventSlug,
        selectedEmail.id,
        testEmailAddress,
      )
  ...
  const modalInputClass =
    'voxxy-input-frost w-full rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-green-500/50'
                            ...
                            return (
                              ...
                              >
                                ...
                                <div className="flex items-center gap-1.5 flex-wrap">
                                  <span
                                    className={`px-1.5 py-0.5 rounded text-[9px] font-medium ${getEmailTypeInfo(email.trigger_type).color}`}
                                  >
                                    {getEmailTypeInfo(email.trigger_type).label}
                                  </span>
                                  <Badge
                                    variant={emailStatusBadge.variant}
                      ...
                      <div className="flex items-start justify-between gap-3">
                        <div className="flex-1 min-w-0">
                                  ...
                                  <Tooltip.Root>
                                    ...
                                    <Tooltip.Portal>
                                      <Tooltip.Content
                                        ...
                                        sideOffset={5}
                                      >
                                        This is a time-based reminder that was added to this event's
                                        sequence.
                                  ...
                                  <Tooltip.Root>
                                    ...
                                    <Tooltip.Portal>
                                      <Tooltip.Content
                                        ...
                                        sideOffset={5}
                                      >
                                        This is a core system email that's automatically triggered
                                        by vendor actions or event milestones.
                                        <Tooltip.Arrow className="fill-gray-900" />
                                      </Tooltip.Content>
                                    </Tooltip.Portal>
                                  </Tooltip.Root>
                          ...
                          <div className="flex items-center gap-2 flex-wrap">
                            ...
                            <Badge
                              variant={getStatusBadge(selectedEmail.status).variant}
                          ...
                          <div className="grid grid-cols-3 gap-3">
                            <div className={detailWellClass}>
                              ...
                              <div className="text-lg font-bold text-foreground">
                                {selectedEmail.recipient_count || 0}
                              </div>
                            </div>
                            {selectedEmail.delivered_count !== undefined && (
                              <div className="p-3 rounded-lg bg-green-500/10 border border-green-500/20">
                                <div className="text-[10px] text-green-400/80 uppercase tracking-wide mb-1">
                                  Delivered
                                </div>
                                <div className="text-lg font-bold text-green-400">
                                  {selectedEmail.delivered_count}
                                </div>
                              </div>
                            )}
                            {selectedEmail.undelivered_count !== undefined &&
                              selectedEmail.undelivered_count > 0 && (
                                <div className="p-3 rounded-lg bg-red-500/10 border border-red-500/20">
                                  <div className="text-[10px] text-red-400/80 uppercase tracking-wide mb-1">
                                    Undelivered
                                  </div>
                                  <div className="text-lg font-bold text-red-400">
                                    {selectedEmail.undelivered_count}
                                  </div>
                                </div>
                              )}
                          </div>
            ...
            <div className="p-4 space-y-4">
              ...
              <div className="p-3 rounded-lg bg-blue-500/10 border border-blue-500/20">
                <p className="text-blue-400 text-xs">
                  This will send a preview of "{selectedEmail?.name}" with all variables populated
                  with sample data.
                </p>
              </div>
            </div>
