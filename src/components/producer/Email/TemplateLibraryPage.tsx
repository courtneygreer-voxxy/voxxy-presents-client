...
export default function TemplateLibraryPage({
  ...
  const handleCloneConfirm = async () => {
    ...
    if (nameExists) {
      ...
      setCloneError(
        `A ${typeLabel} sequence named "${trimmedName}" already exists. Please choose a different name.`,
      )
  ...
  const handleConfirmCreateCategoryTemplate = async (
    categoryId: number,
      ...
      <div className="max-w-7xl mx-auto">
              ...
              return (
                <div className="text-center py-8 px-4">
                  ...
                  <h3 className="text-sm font-medium text-foreground mb-1">
                    Using Default Event Sequence
                  </h3>
                  <p className="text-foreground/60 text-xs mb-4 max-w-sm mx-auto">
                    The default sequence handles invitations, reminders, and event communications.
                    Create additional sequences for different messaging approaches.
                  </p>
                  <button
              ...
              <div>
                <div className="mb-3">
                  ...
                  <p className="text-foreground/60 text-xs">
                    Sent to contacts (invitations, application reminders) and all vendors across all
                    categories (bulletins, updates, cancellations).
                  </p>
                </div>
          ...
          <div className="mt-8">
            <div className="mb-3">
              ...
              <p className="text-xs text-muted-foreground">
                Sent to vendors in each specific category. Applications, payments, and event
                countdowns personalized per vendor type.
              </p>
            </div>
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <div className="flex items-center gap-2">
                          <span
                            className="category-sequence-badge inline-flex items-center gap-1.5 px-2.5 py-1 rounded-md text-sm font-semibold"
        ...
        {!isLoading &&
          ...
          (() => {
            ...
            const universalTemplate = templates.find(
              (t) => t.template_type === 'category' && t.is_universal === true,
            )
            ...
            return (
              <div className="mt-8">
                <div className="mb-3">
                  ...
                  <p className="text-foreground/60 text-xs">
                    Single sequence used across all vendor categories. Simplifies management when
        ...
        {!isLoading && !error && templates.length === 0 && (
          <div className="text-center py-8">
            ...
            <p className="text-foreground/60 text-xs mb-4 max-w-sm mx-auto">
              Default event sequence handles invitations, reminders, and event communications.
              Create custom sequences for different messaging approaches.
            </p>
            <button
              onClick={() => onNavigateToBuilder?.()}
              className="px-4 py-2 rounded-lg voxxy-btn-cta text-sm font-medium transition-all inline-flex items-center gap-2"
