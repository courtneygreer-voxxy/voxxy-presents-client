...
export const EMAIL_VARIABLES: EmailVariable[] = [
  ...
  {
    label: 'Affiliation',
    frontendVar: '[affiliation]',
    backendVar: '{{affiliation}}',
    category: 'vendor',
    description: "Vendor's affiliation (studio, gallery, or business)",
    example: 'Maya Chen Art',
    worksInInvitations: true,
  },
  {
    label: 'Email',
  ...
  {
    label: 'Ticket Code',
    frontendVar: '[ticketCode]',
    backendVar: '{{ticket_code}}',
    category: 'vendor',
    description: 'Unique ticket code assigned to each registrant',
    example: 'TIX-2026-A3F8K',
    worksInInvitations: false,
  },
