    ...
    <div className="min-h-screen voxxy-gradient-page-alt relative overflow-hidden">
      ...
      <section className="relative pt-[140px] pb-20 px-6 md:px-12">
        ...
        <div className="container mx-auto max-w-[900px] text-center relative z-10">
          ...
          <p className="text-[18px] leading-relaxed text-foreground/65 max-w-[700px] mx-auto mb-0">
      ...
      <section className="py-[100px] px-6 md:px-12 bg-background">
        <div className="container mx-auto max-w-[1200px]">
          <div className="mb-14">
            ...
            <h2 className="text-[42px] font-display font-bold leading-tight text-foreground mb-6">Built by producers, for producers</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-12 items-start mb-16">
            ...
            <div className="space-y-4">
              <img
                ...
                className="rounded-xl shadow-lg border border-border w-full h-[300px] object-cover"
                loading="lazy"
              />
              <div className="grid grid-cols-2 gap-4">
                <img
                  ...
                  className="rounded-xl shadow-lg border border-border w-full h-[180px] object-cover"
                  loading="lazy"
                />
                <img
          ...
          {/* Values Grid */}
          <div className="grid md:grid-cols-2 gap-6 max-w-[900px] mx-auto pt-12 border-t border-border">
            <div className="bg-muted border border-border rounded-xl p-6">
              <h4 className="text-[18px] font-bold text-foreground mb-2">🤝 Community First</h4>
            ...
            <div className="bg-muted border border-border rounded-xl p-6">
              <h4 className="text-[18px] font-bold text-foreground mb-2">⚡ Simplicity Over Features</h4>
              <p className="text-[15px] text-gray-700 leading-relaxed">
            ...
            <div className="bg-muted border border-border rounded-xl p-6">
              <h4 className="text-[18px] font-bold text-foreground mb-2">🌍 Representation Matters</h4>
              <p className="text-[15px] text-gray-700 leading-relaxed">
            ...
            <div className="bg-muted border border-border rounded-xl p-6">
              <h4 className="text-[18px] font-bold text-foreground mb-2">🛠️ Built by Producers</h4>
              <p className="text-[15px] text-gray-700 leading-relaxed">
      ...
      {/* CTA Section */}
      <section className="py-24 px-6 md:px-12 bg-gradient-to-r from-primary/10 to-blue-500/10 border-y border-border">
        <div className="container mx-auto max-w-4xl text-center">
          <h2 className="text-[42px] md:text-[48px] font-display font-bold text-foreground mb-6">
            Want to learn more?
          </h2>
          <p className="text-[18px] text-foreground/70 mb-10">
            We'd love to hear about your events.
          </p>
          <TrackedLink
            to="/contact"
            className="inline-flex items-center px-8 py-4 bg-background text-voxxy-purple-brand hover:bg-muted transition-all text-lg font-semibold rounded-xl shadow-lg hover:shadow-xl"
            trackingData={{
