...
export default function VenueOwnerSignUpPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      // The RedirectIfAuthenticated component should handle routing
      // but let's add a small delay to ensure the user profile loads
      setTimeout(() => {
        if (window.location.pathname === '/signup/venue-owner') {
          // Still on signup page, force redirect
          ...
          <Card className="w-full bg-white/15 backdrop-blur-md border border-white/30">
            <CardHeader className="text-center">
              ...
              <div className="flex items-center justify-center gap-2 mb-3">
                ...
                <CardTitle className="text-2xl font-bold text-white">Venue Owner Signup</CardTitle>
              </div>
            ...
            <CardContent>
                ...
                <div className="space-y-2">
                  <div className="flex items-start space-x-2">
                    <input
                      ...
                      className="w-4 h-4 mt-1 text-green-600 bg-white/10 border-white/20 rounded focus:ring-green-500 focus:ring-2"
                      disabled={isSubmitting}
                    />
              ...
              <div className="mt-6 p-4 bg-green-600/20 rounded-lg border border-green-600/30">
                <p className="text-green-300 text-sm text-center">
                  <strong>No waiting required!</strong> Venue owners get immediate access to start listing their venues.
                </p>
              </div>
              ...
              <div className="mt-6 text-center">
                <p className="text-gray-300 text-sm">
                  Already have a venue owner account?{' '}
                  <button
