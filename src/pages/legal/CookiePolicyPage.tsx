      ...
      <div className="space-y-8">
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-4 text-gray-700 leading-relaxed">
            ...
            <p>
              <strong>2.2 Strictly Necessary Cookies.</strong> The only cookies that operate before your consent are those strictly necessary for the functioning of the Services, such as authentication cookies that keep you logged in and security cookies that protect against fraud. These cookies cannot be disabled because the Services would not function without them.
            </p>
            <p>
              <strong>2.3 Changing Your Preferences.</strong> You can change your cookie preferences at any time by clicking the "Cookie Preferences" link in the footer of our website, which will re-display the consent banner and allow you to update your choices.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-4 text-gray-700 leading-relaxed">
            ...
            <p>
              <strong>4.2 Device Identifiers.</strong> We may use device identifiers (such as your device's advertising ID or a unique token generated by the Services) to track, analyze, and improve the performance of the Services. These identifiers are subject to the same consent requirements as analytics cookies.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-4 text-gray-700 leading-relaxed">
            ...
            <p>
              <strong>We do not use cross-site tracking.</strong> We do not track your activity across other websites or apps.
            </p>
          </div>
        </section>
        ...
        <section className="space-y-4">
          ...
          <div className="space-y-4 text-gray-700 leading-relaxed">
            ...
            <p>
              <strong>6.2 Browser Settings.</strong> Most web browsers allow you to control cookies through their settings. You can set your browser to block cookies or to alert you when a cookie is being set. Note that blocking all cookies may affect the functionality of the Services (for example, you may not be able to stay logged in).
            </p>
            <p>
              <strong>6.3 Do Not Track.</strong> Some browsers offer a "Do Not Track" (DNT) feature. Because our consent-first approach means no analytics tracking occurs without your affirmative opt-in, our Services effectively honor the spirit of DNT by default.
            </p>
            <p>
              <strong>6.4 Third-Party Opt-Outs.</strong> You can also manage your preferences directly with our third-party service providers: Mixpanel provides an opt-out mechanism at mixpanel.com/optout; Cloudflare's privacy practices are described at cloudflare.com/privacypolicy.
            </p>
          </div>
        </section>
