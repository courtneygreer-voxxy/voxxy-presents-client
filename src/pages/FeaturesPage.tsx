      ...
      <section className="relative pt-[140px] pb-16 px-6 md:px-12">
        ...
        <div className="container mx-auto max-w-[1200px] relative z-10">
          <div className="text-center max-w-[800px] mx-auto">
            ...
            <p className="text-[18px] leading-relaxed text-white/65 mb-0 max-w-[600px] mx-auto">
        ...
        <div className="container mx-auto max-w-[1200px]">
          <div className="max-w-[800px] mx-auto">
            ...
            <div className="text-center mb-10">
              <h2 className="text-[36px] font-display font-bold text-white mb-4">Trust & Safety Commitment</h2>
            ...
            <div className="bg-white/5 border border-white/10 rounded-2xl p-10">
              <p className="text-[16px] text-white/70 mb-6 leading-relaxed">
              ...
              <p className="mt-8 text-center text-white/50 italic">
